...
Ported from rogue/m_gladiator.h (GNU GPL v2 or later).
*/
// m_gladiator.h -- frame indices
//
// rogue/m_gladiator.h vs baseq2/m_gladiator.h: banner swap only, no other
// delta -- copied verbatim from src/game/m_gladiator_frames.ts.
