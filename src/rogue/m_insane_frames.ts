...
Ported from rogue/m_insane.h (GNU GPL v2 or later).
*/
// m_insane.h -- frame indices
//
// rogue/m_insane.h vs baseq2/m_insane.h: banner swap only, no other delta --
// copied verbatim from src/game/m_insane_frames.ts.
