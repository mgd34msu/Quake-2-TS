...
Ported from rogue/m_float.h.

rogue/m_float.h vs baseq2/m_float.h: banner swap only, no frame-index delta
(diff confirms). Copied verbatim from src/game/m_float_frames.ts.
*/
