...
Ported from rogue/m_boss3.c (GNU GPL v2 or later).
*/
/*
==============================================================================
...
*/
//
// rogue/m_boss3.c vs baseq2/m_boss3.c: banner swap only, no other delta --
// copied from src/game/m_boss3.ts with sibling imports repointed at the
// flat src/rogue/ layout. rogue/m_boss3.c has no companion header of its
// own -- like baseq2, it #includes m_boss32.h for the rider model's
// stand-cycle frame constants (see src/rogue/m_boss32_frames.ts).
