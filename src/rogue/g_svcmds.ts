// g_svcmds.c
//
// rogue/g_svcmds.c vs baseq2/g_svcmds.c: banner-only diff, no functional
// delta. Copied verbatim from src/game/g_svcmds.ts with imports adjusted to
// the rogue-local g_local.ts.
//
