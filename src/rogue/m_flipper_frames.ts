...
Ported from rogue/m_flipper.h (GNU GPL v2 or later).
*/
// m_flipper.h -- frame indices
//
// rogue/m_flipper.h vs baseq2/m_flipper.h: banner swap only, no other delta
// -- copied verbatim from src/game/m_flipper_frames.ts.
