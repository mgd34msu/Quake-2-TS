...
Ported from rogue/m_flipper.c (GNU GPL v2 or later).
*/
/*
==============================================================================
...
// m_flipper.c
//
// rogue/m_flipper.c vs baseq2/m_flipper.c: banner swap only, no other delta
// -- copied from src/game/m_flipper.ts with sibling imports repointed at the
