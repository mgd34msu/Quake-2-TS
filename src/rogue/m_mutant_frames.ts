...
Ported from rogue/m_mutant.h.

rogue/m_mutant.h vs baseq2/m_mutant.h: banner swap plus one addition -- five
new FRAME_jumpNN constants (149-153) appended after FRAME_walk23, used by the
pack's new mutant_jump_up/mutant_jump_down vertical-jump attack in
m_mutant.c.
*/
