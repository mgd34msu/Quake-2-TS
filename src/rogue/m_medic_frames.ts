...
//
// rogue/m_medic.h vs baseq2/m_medic.h: banner swap only -- no frame indices
// added or changed (the pack's medic-commander overhaul lives entirely in
// m_medic.c, reusing the existing FRAME_attack33..FRAME_attack60 span for
// the new medic_move_callReinforcements table). Copied verbatim from
// src/game/m_medic_frames.ts.
