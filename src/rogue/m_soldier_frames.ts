...
// rogue/m_soldier.h vs baseq2/m_soldier.h: banner-only diff (ZeniMax license
// header vs id header); frame indices and MODEL_SCALE are identical. Copied
// verbatim from src/game/m_soldier_frames.ts.
