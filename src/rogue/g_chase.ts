// g_chase.c
//
// rogue/g_chase.c vs baseq2/g_chase.c: banner-only diff (copyright header
// swap), no functional delta. Copied verbatim from src/game/g_chase.ts with
// imports adjusted to the rogue-local g_local.ts.
