...
Ported from rogue/m_parasite.h.

rogue/m_parasite.h vs baseq2/m_parasite.h: banner swap plus eight new
FRAME_jumpNN constants (118-125) appended after FRAME_stand35, for the
pack's new parasite jump-attack (see m_parasite.ts's parasite_jump/
parasite_blocked).
*/
