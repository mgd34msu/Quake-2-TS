...
//
// rogue/m_actor.h vs baseq2/m_actor.h: banner swap only (id copyright block
// vs "Copyright (c) ZeniMax Media Inc."), no other delta -- copied verbatim
// from src/game/m_actor_frames.ts.
