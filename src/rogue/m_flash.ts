// m_flash.c
//
// rogue/m_flash.c vs baseq2/m_flash.c: banner swap only, no other delta --
// the shared table already carries the "ROGUE" pack additions (see the
// comment inline at "note that the above really ends at 137") since
// baseq2's copy is byte-identical; copied verbatim from src/game/m_flash.ts.
// No companion header -- m_flash.c is the shared muzzle-flash offset table.
