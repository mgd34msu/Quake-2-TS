...
Ported from rogue/m_boss31.c (GNU GPL v2 or later).
*/
/*
==============================================================================
...
*/
//
// rogue/m_boss31.c vs baseq2/m_boss31.c: banner swap plus one addition --
// SP_monster_jorg sets `self->monsterinfo.aiflags |= AI_IGNORE_SHOTS;` right
// after walkmonster_start(self) (rogue/m_boss31.c:731-733, wrapped in
// "//PMM"/"//pmm" markers). Everything else is copied from
// src/game/m_boss31.ts with sibling imports repointed at the flat
// src/rogue/ layout.
...
export function SP_monster_jorg(self: EdictT): void {
  ...
  // ROGUE (rogue/m_boss31.c:731-733, "//PMM"/"//pmm")
