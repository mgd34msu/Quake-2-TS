...
export function InitGame(): void {
  ...
  // xatrix/g_save.c: spectator_password loses CVAR_USERINFO (flags 0), and
  // needpass is dropped entirely (g_main.c's Xatrix delta removes it).
  gameCvars.spectator_password = gi.cvar("spectator_password", "", 0);
