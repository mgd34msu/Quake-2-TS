...
// xatrix/g_main.c: `// RAFAEL` delta removes CheckNeedPass() and the
// needpass cvar entirely (g_local.h no longer externs it).
...
export function G_RunFrame(): void {
  ...
  // xatrix/g_main.c drops the needpass cvar and CheckNeedPass() entirely.
