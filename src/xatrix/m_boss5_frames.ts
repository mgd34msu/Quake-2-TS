...
Ported from game/m_supertank.h (GNU GPL v2 or later).

m_boss5.c has no header of its own -- it `#include "m_supertank.h"` directly
(xatrix's build shares baseq2's m_supertank.h unmodified), so this file is a
byte-for-byte copy of ../game/m_supertank_frames.ts kept local to src/xatrix
